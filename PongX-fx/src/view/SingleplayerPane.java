...
public class SingleplayerPane extends Pane {
    ...
    private Label frictionLabel, AILabel;
    private ComboBox  AILevelComboBox, brickSetComboBox;    
    private NumberSpinner frictionSpinner;
    
    private Label singlePlayerHeaderTitle;
    
    private double width, height;
    
    private ObservableList<Integer> AIList;
    ...
    public SingleplayerPane() {
        ...
        AIList = FXCollections.observableArrayList(1,2,3); // for comboBox
        brickList = FXCollections.observableArrayList("Empty brick set", "Brick set 1", "Brick set 2", "Brick set 3");
        
        
        singlePlayerHeaderTitle = new Label("Singleplayer");
        singlePlayerHeaderTitle.getStyleClass().add("paneHeaderLabel");
        singlePlayerHeaderTitle.setLayoutY(height/20);
        singlePlayerHeaderTitle.setLayoutX(width/5);
        ...
        HBox AIHbox = new HBox(AILabel, AILevelComboBox);
        HBox frictionHBox = new HBox(frictionLabel, frictionSpinner);
        AIHbox.setSpacing(20);
        frictionHBox.setSpacing(20);
        VBox leftBox = new VBox(AIHbox, frictionHBox);
        ...
        getChildren().addAll(singlePlayerHeaderTitle,backButton,playButton, leftBox, fieldImagePane, previousMapButton, nextMapButton, brickSetComboBox);
    }
    ...
    public ComboBox getAILevelComboBox() {
        return AILevelComboBox;
    }

    public void setAILevelComboBox(ComboBox AILevelComboBox) {
        this.AILevelComboBox = AILevelComboBox;
    }
